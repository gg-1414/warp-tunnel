...
function userStart() {
  ...
  startBtn.removeEventListener( 'mousedown', userStart );

  startBtn.addEventListener( 'mousedown', audioBtHandler, false );
  startBtn.innerHTML = 'Pause Audio';
  startBtn.style.display = 'none';
  
  txtStatus.innerHTML = 'Loading Audio...';

  // audioSetup( 'http://nkunited.de/ExternalImages/jsfiddle/audio/ChillDay_comp.mp3' );
  audioSetup( 'https://audio-dls.s3.us-east-2.amazonaws.com/LAKEY_INSPIRED-Chill_Day.mp3' );
  // audioSetup( 'LAKEY_INSPIRED-Chill_Day.mp3' );
  animate();
...
function onResize(){
  console.log('winodw.innerWidth', window.innerWidth)
